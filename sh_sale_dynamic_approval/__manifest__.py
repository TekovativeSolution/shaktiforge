...
{
    "name": "Sale Dynamic Approval",
    "author": "Softhealer Technologies",
    "website": "https://www.softhealer.com",
    "support": "support@softhealer.com",
    "category": "Sales",
    "summary": "Dynamic Sale Order Approval Dynamic Sales Approval Sales Multi Approval Sale Order Multiple Approval Quotaion Dynamic Approval Sale Order Double Approval Sale Double Approval Sale User Dynamic Approval User Wise Approval Group Wise Approval Odoo Sale Order Dynamic Approval Quotation Dynamic Approval Dynamic Sale Approval Sale Approval Process Sale Order Approval Process",
