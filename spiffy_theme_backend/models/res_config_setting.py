...
class ResConfig(models.TransientModel):
    ...
    def _get_default_image_background(self):
        image_path = "/opt/teknovate/repo/spiffy_theme_backend/static/src/company_images/login_background.jpg"
    ...
    def _get_default_image(self):
        image_path = "/opt/teknovate/repo/spiffy_theme_backend/static/src/company_images/Shield.png"
        with open(image_path, "rb") as f:
            return base64.b64encode(f.read())
    ...
    def _get_default_menu_logo(self):
        image_path = "/opt/teknovate/repo/spiffy_theme_backend/static/src/company_images/menubar_logo.png"
        with open(image_path, "rb") as f:
            return base64.b64encode(f.read())
