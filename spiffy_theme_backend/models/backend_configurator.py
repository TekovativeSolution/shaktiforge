...
class BackendConfig(models.Model):
	...
	def _default_app_drawer_bg_image(self):
		...
		image_path = file_path('spiffy_theme_backend/static/description/app drawer background.jpg')
		with tools.file_open(image_path, 'rb') as f:
			return base64.b64encode(f.read())
	
	def _default_menu_bg_image(self):
		image_path = file_path('spiffy_theme_backend/static/description/header_vertical_mini.svg')
		with tools.file_open(image_path, 'rb') as f:
			return base64.b64encode(f.read())

	use_custom_colors = fields.Boolean(string="Use Custom Colors", default=True)
	...
	menu_shape_bg_color = fields.Char(string="Enterprise Menu BG Color",default="#F9F9F9")
	menu_shape_bg_color_opacity = fields.Float(string="Menu Shape BG Color Opacity",default="1")

	light_primary_bg_color = fields.Char(string="Primary Background Color for light", default="#024950"
										 # default="#0097a7"
										 )
	light_primary_text_color = fields.Char(string="Primary Text Color for light", default="#x`"
										   # default="#ffffff"
										   )

	apply_light_bg_img = fields.Boolean(string="Apply light bg image", default=True)
	...
	tab = fields.Selection([
		...
		default="tab_style_2", string="Tab Styles")
	...
	chatter_position = fields.Selection([
		...
		default="chatter_bottom", string="Chatter Position")
	...
	top_menu_position = fields.Selection([
		...
		default="top_menu_horizontal", string="Top Menu Position")
	...
	theme_style = fields.Selection([
		...
		default="biz_theme_standard", string="Theme Style")
		# default="biz_theme_rounded", string="Theme Style")

	apply_menu_shape_style = fields.Boolean(string="Apply Menu Shape Stype", default=True)
	...
	attachment_in_tree_view = fields.Boolean(string="Show Attachement in tree view", default=True)
	...
	list_view_density = fields.Selection([
		...
		default="list_compact", string="List View Density")
	...
	input_style = fields.Selection([
		...
		default="input_bordered", string="Form View Mode")
		# default="input_bottom_border", string="Form View Mode")

	list_view_sticky_header = fields.Boolean(string="List view Sticky Header", default=True)
